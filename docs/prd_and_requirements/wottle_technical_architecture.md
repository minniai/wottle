...
> not eight (rules §3.1); the clock is one match-long budget per player (rules §2a);
> the dictionary is the full inflected BÍN list (rules §3.3); the UI is the Field & Ledger room (`docs/design_documentation/README.md`).
