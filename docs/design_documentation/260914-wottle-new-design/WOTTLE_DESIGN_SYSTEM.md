...
- Ledger context strings: `lobby · 4 here` · `10 moves each · one 5:00 clock` · `move 4 of 10` · `final · 4:52`. Ledger clock labels: `match clock` · `last 12s` · `time`.
