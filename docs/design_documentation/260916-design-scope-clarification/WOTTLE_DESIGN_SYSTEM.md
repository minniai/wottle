> Repo note (2026-09-16): this is the design bundle's own copy as authored (seven tokens, 10:00 clocks). The binding design system is `docs/design_documentation/260914-wottle-new-design/WOTTLE_DESIGN_SYSTEM.md` as amended by the team decisions and by P1–P4 of this handoff. Kept for provenance; do not implement from it.
