...
is live-row-styled notices in the ledger (`<name> asks for a rematch · accept ▸ · decline`) and the final room state; `RematchBanner`, `RematchInterstitial` and `FinalSummary` are retired. See `docs/design/README.md`, the plan
