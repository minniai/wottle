...
is the field's pick → preview → commit state machine and the reveal choreography (`Field`); the FLIP swap animation and scored-tile glow are retired. See `docs/design_documentation/README.md`, the plan
