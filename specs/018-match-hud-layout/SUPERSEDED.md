...
**Scope superseded:** the whole spec.

The UI described in this spec was retired by the Field & Ledger rebuild (2026-09-14). Its replacement
is the `Room` grid (bar / field / bar + ledger) with `PlayerBar` replacing the HUD cards and compact mobile bars. See `docs/design_documentation/README.md`, the plan
