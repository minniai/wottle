...
is flat paper cells with 1px rules inside a 1.5px ink frame (`Field`); letterpress tiles and coordinate labels are retired. See `docs/design_documentation/README.md`, the plan
