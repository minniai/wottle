...
is current-round words drawn as live bands at 30% tint that settle to 14%, pins that fade, no locked frame, no lock banner (`Field`). See `docs/design/README.md`, the plan
