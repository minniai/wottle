...
is the lobby room state: empty player bars, warm-up field and `LobbyLedger`; hero, PlayNowCard, LobbyDirectory, LobbyCard, InviteDialog, skeletons and empty states are retired. See `docs/design/README.md`, the plan
