...
is the lobby room state: empty player bars, warm-up field and `LobbyLedger`; hero, PlayNowCard, LobbyDirectory, LobbyCard, InviteDialog, skeletons and empty states are retired. See `docs/design_documentation/README.md`, the plan
