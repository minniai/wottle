...
is the ledger's rounds table and the final room state (`Ledger`); `RoundHistoryPanel`, `RoundSummaryPanel` and the recap sequence are retired. See `docs/design/README.md`, the plan
