...
**Scope superseded:** the UI part only — the shake stays.

The UI described in this spec was retired by the Field & Ledger rebuild (2026-09-14). Its replacement
is a 300ms shake in the letter's own colour plus a live-row notice (`Field`, `Ledger`); `MoveFeedback` toasts and the colour flash are retired. See `docs/design_documentation/README.md`, the plan
