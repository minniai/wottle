  ...
  return (
    <>
      <div className="rules__lede">
        <span className="rules__label">leiðbeiningar</span>
        <h1 className="rules__title">Tveir leikmenn, eitt borð, tíu leikir hvor.</h1>
        <p>
          Orðusta er orðaeinvígi á 10×10 borði af íslenskum stöfum. Báðir leikmenn leika
          þegar þeim hentar, á einni klukku. Sá sem les borðið betur, og nýtir klukkuna
          betur, vinnur.
        </p>
      </div>
      ...
      <section className="rules__section" id="the-move">
        <div>
          ...
          <p>
            Veldu einn staf, svo annan. Þeir skipta um sæti. Það er einn leikur; þú átt
            tíu og leikur þeim þegar þér hentar. Hver leikur er reiknaður um leið og hann
            berst og næsti leikur opnast um leið og þú hefur séð stigin.
          </p>
          <p>
      ...
      <section className="rules__section" id="words">
        <div>
          ...
          <p>
            Eftir hvert skipti er borðið lesið lárétt og lóðrétt út frá stöfunum tveimur
            sem færðust. Hver ný röð þriggja stafa eða fleiri sem er íslenskt orð gefur
            þeim stig sem skiptin gerði. Allar beygingarmyndir gilda, og orð gefur stig
            aftur ef þú myndar það á nýjum stað.
          </p>
          <p>
            Orð er dregið sem band í lit þess sem skoraði, með ör þar sem lesturinn hefst.
          </p>
        </div>
        <RulesFigure
          kind="words"
          caption="BORÐ lesið lárétt, GILT lesið lóðrétt; örin sýnir hvar hvort hefst"
        />
      </section>
      ...
      <section className="rules__section" id="freezing">
        <div>
          ...
          <p>
            Allir stafir orðs sem skorar frjósa. Frosnum stöfum getur enginn skipt aftur,
            svo hvert orð sem þú skorar tekur líka svæði af andstæðingnum. Þar sem orð
            sker orð sem þegar hefur skorað heldur sameiginlegi stafurinn lit þess sem
            frysti hann fyrst.
          </p>
        ...
        <RulesFigure
          kind="crossing"
          caption="LEK sker GILT; L-ið heldur lit andstæðingsins"
        />
      </section>
      ...
      <section className="rules__section" id="scoring">
        <div>
          ...
          <p>
            Heildarstigin þín standa á þínu spjaldi og telja upp um leið og hvert band
            lendir.
          </p>
        </div>
      </section>
