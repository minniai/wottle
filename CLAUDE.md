...
Fixture phases (25): landing-slip, returning-slip, lobby, queue, found, idle, picking, illegal, reveal, final, disconnect, profile, phone-sheet, resign, over-slip, rules, scoring, scored, opp-reveal, rejected, done-waiting, time-up, end-early, low-clock, last-seconds.
