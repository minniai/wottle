...
**The scoreboard (spec `specs/068-match-scoreboard/spec.md`, 2026-09-23, branch `068-match-scoreboard`, Phase A)**:
...
Fixture phases (26): landing-slip, returning-slip, lobby, queue, found, idle, picking, illegal, reveal, final, disconnect, profile, phone-sheet, resign, over-slip, rules, scoring, scored, opp-reveal, rejected, done-waiting, time-up, end-early, low-clock, last-seconds, starting. The phone views `phone-match`, `phone-match-664` and `phone-match-360` are viewport tests over `idle` with their own baselines, not phases.
